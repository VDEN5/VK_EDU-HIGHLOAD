...
|---------|----|-------------|--------------|----------------|
| Email | Cassandra | Горизонтальное масштабирование под 10 трлн писем, высокая скорость записи (4.3k RPS) | По хэшу recipient_email | 3 копии в разных дата-центрах |
